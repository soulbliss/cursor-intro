...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-2 text-left align-middle font-semibold text-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] [&:hover>svg]:text-foreground [&>svg]:text-muted-foreground [&>svg]:ml-2",
      className
    )}
    {...props}
  />
